...
const courseSchema = z.object({
  ...
  status: z.boolean(),
  maximun_quota: z.coerce.number().min(1, { message: 'Maximum quota must be at least 1 ⚠ ' }),
  ...
  classroom_number: z.coerce.number().min(1, { message: 'Classroom number must be at least 1 ⚠' }),
});
